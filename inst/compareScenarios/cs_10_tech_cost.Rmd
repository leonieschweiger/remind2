...
```{r 10_tech_cost/Renewables, storage and nuclear}
showLinePlots(data %>% filter(period >= 2020), "Tech|Electricity|Solar|PV|Capital Costs")
...
```{r 10_tech_cost/Direct and indirect electrifications}
...
```{r 10_tech_cost/Carbon management technologies}
...
### Gas technologies
```{r 10_tech_cost/Gas technologies}
...
### Coal technologies
```{r 10_tech_cost/Coal technologies}
...
```{r 10_tech_cost/Learning renewables and storage vs. cumulative capacity (regional comparison)}
...
```{r 10_tech_cost/Capital cost of non-renewables vs. years (regional comparison)}
items1 <- c(
