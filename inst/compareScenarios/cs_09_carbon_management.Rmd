...
```{r 09_carbon_management/Bio PE2SE Capture by carrier - Bar}
...
```{r 09_carbon_management/Fossil PE2SE Capture by carrier - Bar}
...
```{r 09_carbon_management/Industry Energy Capture by PE - Bar}
...
```{r 09_carbon_management/Carbon Capture from Industry Sector - Bar}
showAreaAndBarPlots(
  data = data,
...
```{r 09_carbon_management/Carbon Capture from CDR Sector - Bar}
showAreaAndBarPlots(
  data = data,
...
## Carbon Usage
### Usage Total - Line
```{r 09_carbon_management/Usage Total - Line}
showLinePlots(data, "Carbon Management|Usage")
```

### Usage for carrier - Bar
```{r 09_carbon_management/Usage for carrier - Bar}
...
```{r 09_carbon_management/Total carbonaceous materials production}
showAreaAndBarPlots(data,
...
```{r 09_carbon_management/Total plastics production}
showLinePlots(data, "Carbon Management|Materials|Plastics")
```

## Plastics production by origin
```{r 09_carbon_management/Plastics production by origin}
showAreaAndBarPlots(data,
...
```{r 09_carbon_management/Plastic waste by fate}
showAreaAndBarPlots(data,
...
```{r 09_carbon_management/Non-plastic waste by fate}
showAreaAndBarPlots(data,
...
```{r 09_carbon_management/Feedstock carbon by SE carrier and fate}
showAreaAndBarPlots(data,
...
## Biochar production
```{r 09_carbon_management/Biochar Plots}
...
## EW rock spreading
```{r 09_carbon_management/CO2 EW rock}
items <- c(
  "CDR|Rocks spread",
