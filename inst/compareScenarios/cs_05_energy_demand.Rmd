...
```{r 05_energy_demand/FE by sector}
items <- c(
  "FE|CDR",
  "FE|Transport",
  "FE|Buildings",
...
```{r 05_energy_demand/Final Energy total}
tot <- "FE"
items <- c(
  "FE|Electricity",
  "FE|Hydrogen",  
...
```{r 05_energy_demand/Final Energy Detail}
tot <- "FE"
items <- c(
  "FE|CDR|Electricity",
...
```{r 05_energy_demand/FE Demand Non-Electric - Carrier and Sector - Bar}
items <- c(
  "FE|CDR|Hydrogen",
  "FE|Transport|Hydrogen",
  "FE|Buildings|Hydrogen",
...
#### FE Total
```{r 05_energy_demand/FE Total}
showLinePlots(data, "FE")
```

#### FE Total without bunkers
```{r 05_energy_demand/FE Total without bunkers}
showLinePlots(data, "FE|w/o Bunkers")
```


#### Electricity
```{r 05_energy_demand/Electricity}
showLinePlots(data, "FE|Electricity")
```

#### Liquids
```{r 05_energy_demand/Liquids}
showLinePlots(data, "FE|Liquids")
```

#### Gases
```{r 05_energy_demand/Gases}
showLinePlots(data, "FE|Gases")
```

#### Solids
```{r 05_energy_demand/Solids}
showLinePlots(data, "FE|Solids")
```

#### Hydrogen
```{r 05_energy_demand/Hydrogen}
showLinePlots(data, "FE|Hydrogen")
```

#### Heat
```{r 05_energy_demand/Heat}
showLinePlots(data, "FE|Heat")
```

### FE Electricity Share
```{r 05_energy_demand/FE Electricity Share}
showLinePlots(data, "FE|Electricity|Share")
```

## Buildings Final Energy

```{r 05_energy_demand/Buildings Final Energy}
tot <- "FE|Buildings"
items <- c(
  "FE|Buildings|Electricity",
  "FE|Buildings|Hydrogen",
...
```{r 05_energy_demand/FE Buildings by carrier - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", scales = "fixed")
```

### FE Buildings - carrier share - Bar 
```{r 05_energy_demand/FE Buildings - carrier share - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", fill = TRUE)
```

### FE Buildings by carrier (detail) - Bar 
```{r 05_energy_demand/FE Buildings by carrier (detail) - Bar}
showAreaAndBarPlots(data, items2, tot, orderVars = "user", scales = "fixed")
```

### FE Buildings Line Plots
```{r 05_energy_demand/Buildings}
...
```{r 05_energy_demand/Electricity Share in Buildings Final Energy}
...
```{r 05_energy_demand/Industry Final Energy}
tot <- "FE|Industry"
items <- c(
  "FE|Industry|Electricity",
  "FE|Industry|Hydrogen",
...
```{r 05_energy_demand/FE Industry by carrier - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", scales = "fixed")
```

### FE Industry - carrier share - Bar 
```{r 05_energy_demand/FE Industry - carrier share - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", fill = TRUE)
```

### FE Industry by carrier (detail) - Bar 
```{r 05_energy_demand/FE Industry by carrier (detail) - Bar}
showAreaAndBarPlots(data, items2, tot, orderVars = "user", scales = "fixed")
```

### FE Industry Line Plots
```{r 05_energy_demand/Industry}
...
```{r 05_energy_demand/FE mix Steel route}
...
#### FE mix Cement
```{r 05_energy_demand/FE mix Cement}
...
```{r 05_energy_demand/FE mix Non-metallic minerals}
...
#### FE mix Chemicals
```{r 05_energy_demand/FE mix Chemicals}
...
#### FE Total Chemicals
```{r 05_energy_demand/FE Total Chemicals}
items <- c(
...
```{r 05_energy_demand/FE mix Other Industry}
...
#### FE Industry line plots
```{r 05_energy_demand/FE Industry line plots}
showLinePlots(data, "FE|Industry|Steel")
...
```{r 05_energy_demand/FE Non-energy Use Industry per carrier and SE origin}
...
```{r 05_energy_demand/Specific Energy Consumption}
...
```{r 05_energy_demand/Transport FE split bunkers vs rest - Bar}
tot <- "FE|Transport"
items <- c(
...
```{r 05_energy_demand/FE Transport per mode}
tot <- "FE|Transport"
items <- c(
...
```{r 05_energy_demand/Transport with Bunkers}
showLinePlots(data, "FE|Transport")
```

#### FE Transport w/o Bunkers - Line 
```{r 05_energy_demand/Transport without Bunkers}
showLinePlots(data, "FE|Transport|w/o Bunkers")
```

#### Road
```{r 05_energy_demand/Road}
showLinePlots(data, "FE|Transport|Road")
```

#### Pass Road
```{r 05_energy_demand/Pass Road}
showLinePlots(data, "FE|Transport|Pass|Road")
```

#### Freight Road
```{r 05_energy_demand/Freight Road}
showLinePlots(data, "FE|Transport|Freight|Road")
```

#### Pass International Aviation 
```{r 05_energy_demand/Pass International Aviation}
showLinePlots(data, "FE|Transport|Bunkers|Pass|International Aviation")
```

#### Pass Domestic Aviation
```{r 05_energy_demand/Pass Domestic Aviation}
showLinePlots(data, "FE|Transport|Pass|Domestic Aviation")
```

#### Pass Road LDV
```{r 05_energy_demand/Pass Road LDV}
showLinePlots(data, "FE|Transport|Pass|Road|LDV")
```

#### Pass Road LDV 4wheeler (Car)
```{r 05_energy_demand/Pass Road LDV 4wheeler Car}
showLinePlots(data, "FE|Transport|Pass|Road|LDV|Four Wheelers")
```

#### Pass Road LDV 2wheeler
```{r 05_energy_demand/Pass Road LDV 2wheeler}
showLinePlots(data, "FE|Transport|Pass|Road|LDV|Two Wheelers")
```

#### Pass Road Bus
```{r 05_energy_demand/Pass Road Bus}
showLinePlots(data, "FE|Transport|Pass|Road|Bus")
```

#### Rail
```{r 05_energy_demand/Rail}
showLinePlots(data, "FE|Transport|Rail")
```

#### Rail - Pass
```{r 05_energy_demand/Rail - Pass}
showLinePlots(data, "FE|Transport|Pass|Rail")
```

#### Rail - Freight
```{r 05_energy_demand/Rail - Freight}
showLinePlots(data, "FE|Transport|Freight|Rail")
```

#### Freight
```{r 05_energy_demand/Freight}
showLinePlots(data, "FE|Transport|Freight")
```
...
```{r 05_energy_demand/FE Transport with Bunkers by carrier - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", scales = "fixed")
```

### FE Transport w/ Bunkers - carrier share - Bar 
```{r 05_energy_demand/FE Transport with Bunkers - carrier share - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", fill = TRUE)
```

### FE Transport w/ Bunkers by carrier (detail) - Bar 
```{r 05_energy_demand/FE Transport with Bunkers by carrier (detail) - Bar}
showAreaAndBarPlots(data, items2, tot, orderVars = "user", scales = "fixed")
```

#### FE Transport w/ Bunkers Synfuel by mode - Bar
```{r 05_energy_demand/FE Transport with Bunkers Synfuel by mode - Bar}
...
```{r 05_energy_demand/FE Transport with Bunkers Biofuel by mode - Bar}
...
```{r 05_energy_demand/Electricity Share in Transport with Bunkers FE}
...
```{r 05_energy_demand/Basics -- without Bunkers}
tot <- "FE|Transport|w/o Bunkers"
items <- c(
...
```{r 05_energy_demand/FE Transport without Bunkers by carrier - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", scales = "fixed")
```

### FE Transport w/o Bunkers - carrier share - Bar 
```{r 05_energy_demand/FE Transport without Bunkers - carrier share - Bar}
showAreaAndBarPlots(data, items, tot, orderVars = "user", fill = TRUE)
```

### FE Transport w/o Bunkers by carrier (detail) - Bar 
```{r 05_energy_demand/FE Transport without Bunkers by carrier (detail) - Bar}
showAreaAndBarPlots(data, items2, tot, orderVars = "user", scales = "fixed")
```
...
```{r 05_energy_demand/Electricity Share in Transport without Bunkers FE}
...
```{r 05_energy_demand/FE CDR by carrier - Bar}
tot <- "FE|CDR"
items <- c(
  "FE|CDR|Electricity",
  "FE|CDR|Hydrogen",
...
### CDR by technology - Bar

```{r 05_energy_demand/FE CDR by technology - Bar}
tot <- "FE|CDR"
items <- c(
  "FE|CDR|DAC",
  "FE|CDR|EW",
...
#### FE OAE, electric calciner

```{r 05_energy_demand/FE OAE electric calciner - Bar}
tot <- "FE|CDR|OAE, electric calciner"
items <- c(
...
#### FE OAE, traditional calciner
```{r 05_energy_demand/FE OAE traditional calciner - Bar}
tot <- "FE|CDR|OAE, traditional calciner"
items <- c(
