...
```{r 11_ces_function/CES Prices Buildings}
...
showLinePlots(data, "Internal|CES Function|CES Price|feelrhcob")
...
```{r 11_ces_function/CES Prices Total Industry}
...
```{r 11_ces_function/CES Prices Steel}
...
```{r 11_ces_function/CES Prices Cement}
...
```{r 11_ces_function/CES Prices Chemicals}
...
```{r 11_ces_function/CES Prices Other Industry}
...
```{r 11_ces_function/MRS Buildings}
...
showLinePlots(data, "Internal|CES Function|MRS|feelhpb|feelrhcob")
...
```{r 11_ces_function/MRS Chemicals}
...
```{r 11_ces_function/MRS Other Industry}
...
```{r 11_ces_function/Buildings Value}
...
showLinePlots(data, "Internal|CES Function|Value|feelalb")
showLinePlots(data, "Internal|CES Function|Value|feelictb")
showLinePlots(data, "Internal|CES Function|Value|feelscb")
```

### Industry

```{r 11_ces_function/Industry Value}
...
```{r 11_ces_function/Transport Value}
