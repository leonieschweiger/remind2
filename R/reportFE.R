...
reportFE <- function(gdx, regionSubsetList = NULL,
  ...
  out <- mbind(
    ...
    # Total
    setNames((dimSums(vm_prodFe, dim = 3, na.rm = TRUE)), "FE (EJ/yr)"),

    # Liquids
    setNames(dimSums(vm_prodFe[, , c("seliqfos", "seliqbio", "seliqsyn")], dim = 3, na.rm = TRUE), "FE|+|Liquids (EJ/yr)"),
    setNames(dimSums(vm_prodFe[, , "seliqbio"], dim = 3, na.rm = TRUE), "FE|Liquids|+|Biomass (EJ/yr)"),
    setNames(dimSums(vm_prodFe[, , "seliqfos"], dim = 3, na.rm = TRUE), "FE|Liquids|+|Fossil (EJ/yr)"),
    setNames(dimSums(mselect(vm_prodFe, all_enty = "seliqsyn"), dim = 3, na.rm = TRUE), "FE|Liquids|+|Hydrogen (EJ/yr)"),

    # Solids
    setNames(dimSums(vm_prodFe[, , c("sesobio", "sesofos")], dim = 3, na.rm = TRUE), "FE|+|Solids (EJ/yr)"),
    setNames(dimSums(vm_prodFe[, , "sesobio"], dim = 3, na.rm = TRUE), "FE|Solids|+|Biomass (EJ/yr)"),
    setNames(p_eta_conv[, , "tdbiosos"] * dimSums(mselect(vm_prodSe, all_enty1 = "sesobio", all_te = "biotrmod"), dim = 3, na.rm = TRUE), "FE|Solids|Biomass|+|Modern (EJ/yr)"),
    setNames(p_eta_conv[, , "tdbiosos"] * dimSums(mselect(vm_prodSe, all_enty1 = "sesobio", all_te = "biotr"), dim = 3, na.rm = TRUE), "FE|Solids|Biomass|+|Traditional (EJ/yr)"),
    setNames(dimSums(vm_prodFe[, , "sesofos"], dim = 3, na.rm = TRUE), "FE|Solids|+|Fossil (EJ/yr)"),
    setNames(p_eta_conv[, , "tdfossos"] * dimSums(mselect(vm_prodSe, all_enty1 = "sesofos", all_enty = "pecoal"), dim = 3, na.rm = TRUE), "FE|Solids|Fossil|+|Coal (EJ/yr)"),

    # Gases
    setNames(dimSums(vm_prodFe[, , c("segafos", "segabio", "segasyn")], dim = 3, na.rm = TRUE), "FE|+|Gases (EJ/yr)"),
    setNames(dimSums(vm_prodFe[, , "segabio"], dim = 3, na.rm = TRUE), "FE|Gases|+|Biomass (EJ/yr)"),
    setNames(dimSums(vm_prodFe[, , "segafos"], dim = 3, na.rm = TRUE), "FE|Gases|+|Fossil (EJ/yr)"),
    setNames(dimSums(mselect(vm_prodFe, all_enty = "segasyn"), dim = 3, na.rm = TRUE), "FE|Gases|+|Hydrogen (EJ/yr)"),

    # Electricity
    setNames(dimSums(vm_prodFe[, , c("feels", "feelt")], dim = 3, na.rm = TRUE), "FE|+|Electricity (EJ/yr)"),

    # Heat
    setNames(dimSums(vm_prodFe[, , "sehe.fehes.tdhes"], dim = 3, na.rm = TRUE), "FE|+|Heat (EJ/yr)"),

    # Hydrogen
    setNames(dimSums(vm_prodFe[, , c("feh2s", "feh2t")], dim = 3, na.rm = TRUE), "FE|+|Hydrogen (EJ/yr)"),

    # Emission markets
    setNames((dimSums(mselect(vm_demFeSector, all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|ESR (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|ETS (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Outside ETS and ESR (EJ/yr)")
  )
  ...
  out <- mbind(
    ...
    # industry
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|++|Industry (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|++|ESR (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|++|ETS (EJ/yr)"),

    # industry liquids
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Liquids|+|Hydrogen (EJ/yr)"),

    # industry solids
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|+|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Solids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|+|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Solids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|+|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Solids|+|Fossil (EJ/yr)"),

    # industry gases
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|Gases|+|Hydrogen (EJ/yr)"),

    # industry electricity
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feels", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|+|Electricity (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feels", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|+|Electricity (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feels", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|+|Electricity (EJ/yr)"),

    # industry heat
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehes", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|+|Heat (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehes", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|+|Heat (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehes", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|+|Heat (EJ/yr)"),

    # industry hydrogen
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2s", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|Industry|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2s", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Industry|ESR|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2s", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Industry|ETS|+|Hydrogen (EJ/yr)"),


    # transport
    ## all transport variables include bunkers, except when expressly written otherwise in the variable name
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|++|Transport (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|++|ESR (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|++|Outside ETS and ESR (EJ/yr)"),

    # transport liquids
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqbio", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqfos", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqsyn", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqbio", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqfos", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqsyn", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqbio", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqfos", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet", "fedie"), all_enty = "seliqsyn", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet"), all_enty = "seliqbio", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|LDV|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet"), all_enty = "seliqfos", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|LDV|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet"), all_enty = "seliqsyn", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|LDV|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fedie"), all_enty = "seliqbio", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|non-LDV|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fedie"), all_enty = "seliqfos", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|non-LDV|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fedie"), all_enty = "seliqsyn", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|non-LDV|Liquids|+|Hydrogen (EJ/yr)"),

    # transport gases
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segabio", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segafos", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segasyn", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segabio", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segafos", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segasyn", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segabio", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segafos", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegat", all_enty = "segasyn", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|Gases|+|Hydrogen (EJ/yr)"),

    # transport electricity
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feelt", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|+|Electricity (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feelt", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|+|Electricity (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feelt", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|+|Electricity (EJ/yr)"),

    # transport hydrogen
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2t", emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2t", emi_sectors = "trans", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Transport|ESR|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2t", emi_sectors = "trans", all_emiMkt = "other"), dim = 3, na.rm = TRUE)), "FE|Transport|Outside ETS and ESR|+|Hydrogen (EJ/yr)"),


    # Buildings
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|++|Buildings (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|++|ESR (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|++|ETS (EJ/yr)"),

    # buildings liquids
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|+|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Liquids|+|Hydrogen (EJ/yr)"),

    # buildings solids
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|+|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Solids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|+|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Solids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|+|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Solids|+|Fossil (EJ/yr)"),

    # buildings gases
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|+|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|Gases|+|Hydrogen (EJ/yr)"),

    # buildings electricity
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feels", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|+|Electricity (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feels", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|+|Electricity (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feels", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|+|Electricity (EJ/yr)"),

    # buildings heat
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehes", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|+|Heat (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehes", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|+|Heat (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "fehes", emi_sectors = "build", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|Buildings|ETS|+|Heat (EJ/yr)"),

    # buildings hydrogen
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2s", emi_sectors = "build"), dim = 3, na.rm = TRUE)), "FE|Buildings|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = "feh2s", emi_sectors = "build", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|Buildings|ESR|+|Hydrogen (EJ/yr)"),
  ...
  out <- mbind(
    out,
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fepet"), emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|LDV|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty1 = c("fedie"), emi_sectors = "trans"), dim = 3, na.rm = TRUE)), "FE|Transport|non-LDV|Liquids (EJ/yr)")
  )


  ### FE carriers from specific PE origin

  p_share_coal_liq <- dimSums(mselect(vm_prodSe, all_enty = "pecoal", all_enty1 = "seliqfos"), dim = 3) / dimSums(mselect(vm_prodSe, all_enty1 = "seliqfos"), dim = 3, na.rm = TRUE)
  p_share_oil_liq <- dimSums(mselect(vm_prodSe, all_enty = "peoil", all_enty1 = "seliqfos"), dim = 3) / dimSums(mselect(vm_prodSe, all_enty1 = "seliqfos"), dim = 3, na.rm = TRUE)
  p_share_gas_liq <- dimSums(mselect(vm_prodSe, all_enty = "pegas", all_enty1 = "seliqfos"), dim = 3) / dimSums(mselect(vm_prodSe, all_enty1 = "seliqfos"), dim = 3, na.rm = TRUE)
  ...
  p_share_ngas_gas <- dimSums(mselect(vm_prodSe, all_enty = "pegas", all_enty1 = "segafos"), dim = 3) / dimSums(mselect(vm_prodSe, all_enty1 = "segafos"), dim = 3, na.rm = TRUE)
  p_share_coal_gas <- dimSums(mselect(vm_prodSe, all_enty = "pecoal", all_enty1 = "segafos"), dim = 3) / dimSums(mselect(vm_prodSe, all_enty1 = "segafos"), dim = 3, na.rm = TRUE)
  ...
  out <- mbind(
    ...
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = "fehos", emi_sectors = "indst") * p_share_oil_liq, dim = 3, na.rm = TRUE)), "FE|Industry|Liquids|Fossil|+|Oil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = "fehos", emi_sectors = "indst") * p_share_gas_liq, dim = 3, na.rm = TRUE)), "FE|Industry|Liquids|Fossil|+|Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = "fehos", emi_sectors = "indst") * p_share_coal_liq, dim = 3, na.rm = TRUE)), "FE|Industry|Liquids|Fossil|+|Coal (EJ/yr)"),

    # buildings fossil liquids
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = "fehos", emi_sectors = "build") * p_share_oil_liq, dim = 3, na.rm = TRUE)), "FE|Buildings|Liquids|Fossil|+|Oil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = "fehos", emi_sectors = "build") * p_share_gas_liq, dim = 3, na.rm = TRUE)), "FE|Buildings|Liquids|Fossil|+|Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = "fehos", emi_sectors = "build") * p_share_coal_liq, dim = 3, na.rm = TRUE)), "FE|Buildings|Liquids|Fossil|+|Coal (EJ/yr)"),

    # transport fossil liquids
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = c("fepet", "fedie"), emi_sectors = "trans") * p_share_oil_liq, dim = 3, na.rm = TRUE)), "FE|Transport|Liquids|Fossil|+|Oil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = c("fepet", "fedie"), emi_sectors = "trans") * p_share_gas_liq, dim = 3, na.rm = TRUE)), "FE|Transport|Liquids|Fossil|+|Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = c("fepet", "fedie"), emi_sectors = "trans") * p_share_coal_liq, dim = 3, na.rm = TRUE)), "FE|Transport|Liquids|Fossil|+|Coal (EJ/yr)"),

    # industry fossil gases
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "segafos", all_enty1 = "fegas", emi_sectors = "indst") * p_share_ngas_gas, dim = 3, na.rm = TRUE)), "FE|Industry|Gases|Fossil|+|Natural Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "segafos", all_enty1 = "fegas", emi_sectors = "indst") * p_share_coal_gas, dim = 3, na.rm = TRUE)), "FE|Industry|Gases|Fossil|+|Coal (EJ/yr)"),

    # buildings fossil gases
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "segafos", all_enty1 = "fegas", emi_sectors = "build") * p_share_ngas_gas, dim = 3, na.rm = TRUE)), "FE|Buildings|Gases|Fossil|+|Natural Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "segafos", all_enty1 = "fegas", emi_sectors = "build") * p_share_coal_gas, dim = 3, na.rm = TRUE)), "FE|Buildings|Gases|Fossil|+|Coal (EJ/yr)"),

    # transport fossil gases
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "segafos", all_enty1 = "fegat", emi_sectors = "trans") * p_share_ngas_gas, dim = 3, na.rm = TRUE)), "FE|Transport|Gases|Fossil|+|Natural Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "segafos", all_enty1 = "fegat", emi_sectors = "trans") * p_share_coal_gas, dim = 3, na.rm = TRUE)), "FE|Transport|Gases|Fossil|+|Coal (EJ/yr)"),

    # total fossil liquids
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = c("fehos", "fepet", "fedie")) * p_share_oil_liq, dim = 3, na.rm = TRUE)), "FE|Liquids|Fossil|+|Oil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = c("fehos", "fepet", "fedie")) * p_share_gas_liq, dim = 3, na.rm = TRUE)), "FE|Liquids|Fossil|+|Gas (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector, all_enty = "seliqfos", all_enty1 = c("fehos", "fepet", "fedie")) * p_share_coal_liq, dim = 3, na.rm = TRUE)), "FE|Liquids|Fossil|+|Coal (EJ/yr)")
  ...
  var_with_Bunkers <- mbind(
    lapply(
      ...
      function(x) {
        setNames(out[, , x], gsub(
          "FE\\|Transport\\|Outside ETS and ESR",
  ...
  out <- mbind(
    out,
    setNames(
      out[, , "FE (EJ/yr)"] - out[, , "FE|Transport|Bunkers (EJ/yr)"],
  ...
  if (buil_mod == "simple") {
    ...
    if (!is.null(p36_uedemand_build)) {
      ...
      out <- mbind(
        out,
        setNames(
          dimSums(out[, , gsub("^FE", "UE", carrierBuildHeating)],
                  dim = 3, na.rm = TRUE
          ),
      ...
      out <- mbind(
        out,
        setNames(
          dimSums(out[, , gsub("^FE", "UE", carrierBuild)],
                  dim = 3, na.rm = TRUE
          ),
          "UE|Buildings (EJ/yr)"
        )
  ...
  out <- mbind(
    c(
      list(out), # pass a list of magpie objects
  ...
  if (indu_mod == "subsectors") {
    ...
    out <- mbind(
      c(
        ...
        list(setNames(
          mselect(vm_cesIO, all_in = "ue_industry"),
    ...
    if (steel_process_based) {
      ...
      out <- mbind(c(
        list(out),
        .select_sum_name_multiply(o37_ProdIndRoute, .mixer_to_selector(mixer), factor = 1e3)
      )) # factor 1e3 converts Gt/yr to Mt/yr
    }
  ...
  if (tran_mod == "edge_esm") {
    ...
    out <- mbind(
      out,
      setNames(dimSums(vm_demFeForEs_trnsp[, , "eselt_frgt_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Electricity (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "eselt_pass_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Electricity (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esdie_frgt_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , c("esdie_pass_", "espet_pass_"), pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esgat_frgt_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Gases (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esgat_pass_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Gases (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esh2t_pass_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Hydrogen (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esh2t_frgt_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Hydrogen (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "eselt_frgt_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Short-Medium distance|Electricity (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "eselt_pass_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Short-Medium distance|Electricity (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esdie_frgt_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Short-Medium distance|Diesel Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esdie_pass_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Short-Medium distance|Diesel Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "espet_pass_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Short-Medium distance|Petrol Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esdie_frgt_lo", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Long distance|Diesel Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esdie_pass_lo", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Long distance|Diesel Liquids (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esgat_frgt_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Short-Medium distance|Gases (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esgat_pass_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Short-Medium distance|Gases (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esh2t_pass_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass|Short-Medium distance|Hydrogen (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "esh2t_frgt_sm", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight|Short-Medium distance|Hydrogen (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "_frgt_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Freight (EJ/yr)"),
      setNames(dimSums(vm_demFeForEs_trnsp[, , "_pass_", pmatch = TRUE], dim = 3, na.rm = TRUE), "FE|Transport|Pass (EJ/yr)"),
      setNames(
        dimSums(vm_cesIO[, , "entrp_frgt_", pmatch = TRUE], dim = 3, na.rm = TRUE) / TWa_2_EJ * 1e3, # remove EJ conversion factor, conv. trillion to billion tkm
        "ES|Transport|Freight (billion tkm/yr)"
      ),
      setNames(
        dimSums(vm_cesIO[, , "entrp_pass_", pmatch = TRUE], dim = 3, na.rm = TRUE) / TWa_2_EJ * 1e3, # trillion to billion pkm
        "ES|Transport|Pass (billion pkm/yr)"
      ),
      setNames(
        dimSums(vm_cesIO[, , "entrp_frgt_sm", pmatch = TRUE], dim = 3, na.rm = TRUE) / TWa_2_EJ * 1e3, # trillion to billion tkm
        "ES|Transport|Freight|Short-Medium distance (billion tkm/yr)"
      ),
      setNames(
        dimSums(vm_cesIO[, , "entrp_pass_sm", pmatch = TRUE], dim = 3, na.rm = TRUE) / TWa_2_EJ * 1e3, # trillion to billion pkm
        "ES|Transport|Pass|Short-Medium distance (billion pkm/yr)"
      ),
      setNames(
        dimSums(vm_cesIO[, , "entrp_frgt_lo", pmatch = TRUE], dim = 3, na.rm = TRUE) / TWa_2_EJ * 1e3, # trillion to billion tkm
        "ES|Transport|Freight|Long distance (billion tkm/yr)"
      ),
      setNames(
        dimSums(vm_cesIO[, , "entrp_pass_lo", pmatch = TRUE], dim = 3, na.rm = TRUE) / TWa_2_EJ * 1e3, # trillion to billion pkm
    ...
    out <- mbind(
      out,
      setNames(
        out[, , "FE|Transport|Pass|Short-Medium distance|Diesel Liquids (EJ/yr)"] +
  ...
  for (CDR_te in getItems(v33_FEdemand, dim = "all_te")) {
    out <- mbind(out, setNames(
      dimSums(mselect(v33_FEdemand, all_te = CDR_te)),
    ...
    for (CDR_FE in getItems(mselect(v33_FEdemand, all_te = CDR_te), dim = "all_enty")) {
      ...
      out <- mbind(out, setNames(
        dimSums(mselect(v33_FEdemand, all_te = CDR_te, all_enty = CDR_FE)),
        variable_name
      ))
    }
  }
  ...
  out <- mbind(out, setNames(
    asS4(pmin(
      out[, , "FE|Solids|Biomass|+|Traditional (EJ/yr)"],
  ...
  out <- mbind(
    out,
    setNames(
      out[, , "FE|Buildings|Solids|+|Biomass (EJ/yr)"] - out[, , "FE|Buildings|Solids|Biomass|+|Traditional (EJ/yr)"],
      "FE|Buildings|Solids|Biomass|+|Modern (EJ/yr)"
    ),
    setNames(
      out[, , "FE|Industry|Solids|+|Biomass (EJ/yr)"] - out[, , "FE|Industry|Solids|Biomass|+|Traditional (EJ/yr)"],
  ...
  out <- mbind(
    out,
    setNames(
      dimSums(vm_demFENonEnergySector, dim = 3),
      "FE|Non-energy Use (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst"), dim = 3),
      "FE|Non-energy Use|+|Industry (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fesos"), dim = 3),
      "FE|Non-energy Use|Industry|+|Solids (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fehos"), dim = 3),
      "FE|Non-energy Use|Industry|+|Liquids (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fegas"), dim = 3),
  ...
  out <- mbind(
    out,
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fesos", all_enty = "sesofos"), dim = 3),
      "FE|Non-energy Use|Industry|Solids|+|Fossil (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fesos", all_enty = "sesobio"), dim = 3),
      "FE|Non-energy Use|Industry|Solids|+|Biomass (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fehos", all_enty = "seliqfos"), dim = 3),
      "FE|Non-energy Use|Industry|Liquids|+|Fossil (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fehos", all_enty = "seliqbio"), dim = 3),
      "FE|Non-energy Use|Industry|Liquids|+|Biomass (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fehos", all_enty = "seliqsyn"), dim = 3),
      "FE|Non-energy Use|Industry|Liquids|+|Hydrogen (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fegas", all_enty = "segafos"), dim = 3),
      "FE|Non-energy Use|Industry|Gases|+|Fossil (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fegas", all_enty = "segabio"), dim = 3),
      "FE|Non-energy Use|Industry|Gases|+|Biomass (EJ/yr)"
    ),
    setNames(
      dimSums(mselect(vm_demFENonEnergySector, emi_sectors = "indst", all_enty1 = "fegas", all_enty = "segasyn"), dim = 3),
  ...
  out <- mbind(
    ...
    # total
    setNames(
      dimSums(vm_demFeSector_woNonEn, dim = 3),
  ...
  out <- mbind(
    ...
    # industry
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS (EJ/yr)"),

    # industry liquids
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Liquids|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Liquids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqbio", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Liquids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqfos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Liquids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fehos", all_enty = "seliqsyn", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Liquids|+|Hydrogen (EJ/yr)"),

    # industry solids
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Solids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Solids|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Solids (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", all_enty = "sesobio", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Solids|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fesos", all_enty = "sesofos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Solids|+|Fossil (EJ/yr)"),

    # industry gases
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "indst"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "indst", all_emiMkt = "ES"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ESR|Gases|+|Hydrogen (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Gases (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segabio", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Gases|+|Biomass (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segafos", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Gases|+|Fossil (EJ/yr)"),
    setNames((dimSums(mselect(vm_demFeSector_woNonEn, all_enty1 = "fegas", all_enty = "segasyn", emi_sectors = "indst", all_emiMkt = "ETS"), dim = 3, na.rm = TRUE)), "FE|w/o Non-energy Use|Industry|ETS|Gases|+|Hydrogen (EJ/yr)")
  )
